...
knitr::opts_chunk$set(echo = TRUE, message = FALSE, fig.width = 4.5, fig.height = 3)
```
...
$(\alpha,x)\mapsto \alpha x$, where $x,y\in V$ and $\alpha\in K$.
