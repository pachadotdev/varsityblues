...
% plain enumeration
\setbeamertemplate{enumerate item}{\color{myblue}\insertenumlabel.}
\setbeamertemplate{enumerate subitem}{\color{myblue}\insertsubenumlabel.}
\setbeamertemplate{enumerate subsubitem}{\color{myblue}\insertsubsubenumlabel.}
...
% redefine TOC to use simple enumeration
% \setbeamertemplate{section in toc}{\color{myblue}\inserttocsectionnumber.~\inserttocsection}
      ...
      \node[text width=\paperwidth, fill=myblue] at (0,0) {
        ...
        \begin{tabular}{lr}
          ...
          \begin{minipage}{.44\textwidth}
            \begin{flushright}
              \includegraphics[width=0.30\paperwidth]{../tex/uofthall.png}
            \end{flushright}
          \end{minipage}
        \end{tabular}
      };
