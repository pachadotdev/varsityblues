...
# This chunk ensures that the varsityblues package is
# installed and loaded. This varsityblues package includes
# the template files for the thesis.
if (!require(remotes)) {
  if (params$`Install needed packages for {varsityblues}`) {
